...
export default function Cart() {
  ...
  const { quantity, cartItems, total } = useSelector(
  ...
  return (
    <>
      ...
      <div className="fixed z-50 top-0 left-0 w-1/3 h-full bg-pastel-200 p-6 rounded-r-lg shadow-lg overflow-y-auto">
        ...
        <div>
          {cartItems.length === 0 ? (
            <div className="text-center text-2xl uppercase text-black">
            ...
            <>
              ...
              <Link to="/checkout">
                <div className="text-center bg-white text-primary p-3 mt-8 rounded-xl hover:bg-gray-100 transition duration-300">
